...
<p align="justify">Extension for the github.com/AUTOMATIC1111/stable-diffusion-webui, which is adding buttons for the selection of predefined aspect ratios from within the web UI.</p>
